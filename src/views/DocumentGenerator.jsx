...
export default function DocumentGenerator() {
  ...
  const handleBuildDocx = async () => {
    ...
    try {
      ...
      // TODO: Log document generation (función logDocumentGeneration pendiente de implementar)
      // if (user) {
      ...
      //   const estimatedPages = data.pages || Math.ceil(blob.size / 50000)
      ...
      // TODO: Log failed generation (función logDocumentGeneration pendiente de implementar)
      // if (user) {
      //   const documentTypeMap = {
      //     'efdt': 'EFDT',
      //     'requirements': 'Requirements',
