  ...
  async function renderHome() {
    ...
    const html = `
      <section class="panel resultados" id="mainPanel" style="overflow-y: auto; max-height: calc(100vh - 180px); padding: 1.5rem;">
        ...
        <!-- HERO BANNER -->
        <div style="width: calc(100% + 3rem); height: 200px; margin: 0 -1.5rem 2rem -1.5rem; border-radius: 12px; overflow: hidden; background: linear-gradient(135deg, rgba(40,215,199,0.2) 0%, rgba(88,166,255,0.1) 100%);">
